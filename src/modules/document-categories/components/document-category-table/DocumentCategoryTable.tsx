...
import { useDocumentCategoryTableContext } from "../../context/document-category-table.context";
import { useDocumentCategoryContext } from "../../context/document-category.context";
...
interface DocumentCategoryTableContextType {
    ...
    columns: ColumnDef<DocumentCategory, unknown>[];
...
export const DocumentCategoryTable: React.FC = () => {
    ...
    const {
        ...
        documentCategories,
        paginationMeta
    } = useDocumentCategoryTableContext() as unknown as DocumentCategoryTableContextType;

    const { handleExportToExcel: exportToExcel, isLoading } = useDocumentCategoryContext();
            ...
            if (selectedIds.length > 0) {
                try {
                    ...
                    toast.error("Error de exportación", {
                        description: "No se pudieron exportar las categorías seleccionadas."
                    });
                }
            } else {
                toast.warning("Selección vacía", {
                    description: "No hay categorías seleccionadas para exportar"
                });
            }
        }
    };
    ...
    const handleOpenBulkDeleteModal = () => {
        if (getSelectedCategoryIds) {
            ...
            if (selectedIds.length > 0) {
                ...
                toast.warning("Selección vacía", {
                    description: "No hay categorías seleccionadas para eliminar"
                });
            }
        }
    };
        ...
        <div className="w-full">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        <Table>
                            ...
                            <TableBody>
                                {isLoading && documentCategories.length === 0 ? (
                                    <TableRow>
            ...
            <DeleteModal
                ...
                description={`¿Estás seguro que deseas eliminar ${totalSelectedRows} ${
                    totalSelectedRows === 1 ? "categoría" : "categorías"
